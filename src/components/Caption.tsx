...
export default function Caption() {
  return (
    <motion.div
      ...
      className="fixed z-20 pointer-events-none mix-blend-exclusion left-4 sm:left-8 top-[118px] sm:top-[180px] lg:top-[244px] w-[calc(100vw-32px)] sm:w-[calc(50vw-48px)] lg:w-[692px]"
    >
